...
export const metadata: Metadata = {
  ...
  keywords: ["Questionário", "Pesquisa", "Formulários", "Coleta de Dados", "Respostas", "Análise", "Questionize"],
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased light bg-slate-50`}>
        {children}
      </body>
    </html>
  );
