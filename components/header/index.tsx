            ...
            <Dialog open={open} onOpenChange={setOpen}>
              ...
              <DialogContent>
                <div className="absolute top-0 left-0 w-screen h-screen flex items-center justify-center">
                  <div  className="absolute top-0 left-0 w-screen h-screen bg-[#00000050] z-0" onClick={() => setOpen(false)}></div>
                  <div className="border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg bg-white z-40">
                    <DialogHeader className="flex flex-row">
                      <DialogTitle className="font-bold w-full">Projeto de Extensão</DialogTitle>
                      <DialogTitle className=" text-end cursor-pointer m-0 p-0 !mt-0 text-black/50" onClick={() => setOpen(false)}>X</DialogTitle>
                    </DialogHeader>
                    ...
                    <div className="flex items-center space-x-2 pt-4">
                      <AvatarHolder label="Equipe">
                        <AvatarCard name="Arthur Marques de Oliveira" fallback="AM" src="https://github.com/arthurm9.png" />
                        <AvatarCard name="João Erik da Silva Crisostomo" fallback="JE" src="https://github.com/joao-erik2077.png" />
                        <AvatarCard name="Lucas Vieira da Silva" fallback="LV" src="https://github.com/lucasvieiras.png" />
                      </AvatarHolder>
                    </div>
                    <div className="flex items-center space-x-2 pt-4">
                    ...
                    <div className="flex items-center space-x-2 pt-4">
                      <div className="grid grid-cols-2 items-center min-h-12 w-full">
                        <div className="w-full h-fit flex flex-start flex-col items-center">
                          ...
                          <p className="w-full text-xs text-zinc-700 dark:text-zinc-300">José Augusto Magalhães – Coordenador de Extensão</p>
                        </div>
